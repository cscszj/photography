...
var user_configuration={
	...
	initial_size:"32px", //initial size of the stars
	final_size:"96px", //final size of the stars after expansion
	expand_speed:"2s", //how fast the stars get bigger, in milliseconds
	fade_delay:"1s", //how long until the star fades out
	fade_duration:"2s", //how long the star fades for
	colors:["rgba(107, 247, 156, 0.8)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
